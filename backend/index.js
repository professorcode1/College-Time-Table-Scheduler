...
app.use('/static', express_1.default.static(__dirname + '/build/static'));
app.use(cookieparse());
app.get("/", (req, res) => {
...
app.get("/collegeSchduler/generateSchedule", (req, res) => {
    res.sendFile(path_1.default.join(__dirname, "webPages", "waitingAnt.html"));
});
app.get("/particles.js-master/demo/js/app.js", (req, res) => {
    res.sendFile(path_1.default.join(__dirname, "build", "static", "particles.js-master", "demo", "js", "app.js"));
});
app.get("/collegeSchduler/particles.js-master/particles.js", (req, res) => {
    res.sendFile(path_1.default.join(__dirname, "build", "static", "particles.js-master", "particles.js"));
});
app.get("/collegeSchduler/ant-colonoy-webambly/scheduler.js", (req, res) => {
    res.sendFile(path_1.default.join(__dirname, "build", "static", "ant-colonoy-webambly", "scheduler.js"));
});
app.get("/collegeSchduler/ant-colonoy-webambly/ant_colony.js", (req, res) => {
    res.sendFile(path_1.default.join(__dirname, "build", "static", "ant-colonoy-webambly", "ant_colony.js"));
});
app.get("/collegeSchduler/ant-colonoy-webambly/ant_colony.wasm", (req, res) => {
    res.sendFile(path_1.default.join(__dirname, "build", "static", "ant-colonoy-webambly", "ant_colony.wasm"));
});
app.get("/collegeSchduler/graph/lib/graph.js", (req, res) => {
    res.sendFile(path_1.default.join(__dirname, "build", "static", "graph", "lib", "graph.js"));
});
